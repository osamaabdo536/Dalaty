...
class DetailsSearch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var args = ModalRoute.of(context)!.settings.arguments as SearchResponse;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoCard(context, args.name ?? 'not detected'),
            SizedBox(height: MediaQuery.of(context).size.height * 0.01,),
            _buildSectionTitle(context, 'Contact'),
            _buildInfoCard(context, args.name ?? "No mobile number available"),
          ],
        ),
      ),
    );
